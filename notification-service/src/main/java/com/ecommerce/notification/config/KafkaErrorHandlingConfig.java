 ...
 *
 * <p>notification-service produces no topics of its own (see ARCHITECTURE.md — it's a
 * pure consumer of notification.requested), so this is the first config/ class here;
 * everywhere else this pattern sits alongside an existing KafkaTopicConfig.
 */
@Configuration
